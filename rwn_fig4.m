0.52502, 0.553485, 0.583426, 0.615122, 0.648932, 0.685344, 0.72503, 0.768967, 0.818652, 0.876542, 0.94706, 1.039, 1.16891, 1.33109, 1.461, 1.55294, 1.62346, 1.68135, 1.73103, 1.77497, 1.81466, 1.85107, 1.88488, 1.91657, 1.94652, 1.97498, 2.00219, 2.02831, 2.05348, 2.07784, 2.10146, 2.12445, 2.14686, 2.16876, 2.19021, 2.21125, 2.23193, 2.25228, 2.27235, 2.29215, 2.31173, 2.3311, 2.35029, 2.36933, 2.38824, 2.40703, 2.42573, 2.44436, 2.46294, 2.48148, 2.5, 2.51852, 2.53706, 2.55564, 2.57427, 2.59297, 2.61176, 2.63067, 2.64971, 2.6689, 2.68827, 2.70785, 2.72765, 2.74772, 2.76807, 2.78875, 2.80979, 2.83124, 2.85314, 2.87555, 2.89854, 2.92216, 2.94652, 2.97169, 2.99781, 3.02502, 3.05348, 3.08343, 3.11512, 3.14893, 3.18534, 3.22503, 3.26897, 3.31865, 3.37654, 3.44706, 3.539, 3.66891, 3.83109, 3.961, 4.05294, 4.12346, 4.18135, 4.23103, 4.27497, 4.31466, 4.35107, 4.38488, 4.41657, 4.44652, 4.47498, 4.50219, 4.52831, 4.55348, 4.57784, 4.60146, 4.62445, 4.64686, 4.66876, 4.69021, 4.71125, 4.73193, 4.75228, 4.77235, 4.79215, 4.81173, 4.8311, 4.85029, 4.86933, 4.88824, 4.90703, 4.92573, 4.94436, 4.96294, 4.98148, 5];

dx = 0.0666667; % continuum model. Initial guess, may be adapted slightly
M = 150
dx = (x_max - x_min)/M;
...
if solve_continuous    
    ...
    dt = 0.0002; % continuum model. Must have dt < 0.5*dx^2*D (CFL condition)
    dx = 0.0666667; % continuum model. Initial guess, may be adapted slightly
    M = 150
    dx = (x_max - x_min)/M;
    ...
    Dt_over_dt = 50; % 1,2,3,...,10,...,100 as needed for precision
    dt = Dt/Dt_over_dt
    % assert(dt < dt_CFL)
...
function x=x_vs_i(i)
    ...
    x = xi + (1/pi)*sin(4*pi.*xi/5); % sin lattice [=xi+A*sin(k*xi)]
...
function xi=xi_vs_x(x)
    ...
    % sin lattice:
    % Use the file xi_vs_x_fig4.dat in which xi(x) is tabulated for half integer steps dx; i2 is an integer that corresponds to 2*i (i is a half integer)
...
function y=g(x) % metric
    ...
    y = 1 + 0.8*cos(4*pi*xi_vs_x(x)/5); % sin lattice [= 1+k*A*cos(k*xi(x))]    
